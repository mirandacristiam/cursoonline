...
<head>
    ...
    .dashboard-wrapper { height:100vh !important; overflow:hidden !important; }
    .sidebar { position:fixed !important; top:0 !important; left:0 !important; bottom:0 !important; width:260px !important; z-index:1050 !important; overflow-y:auto !important; display:flex !important; flex-direction:column !important; }
    .top-navbar { position:fixed !important; top:0 !important; left:260px !important; right:0 !important; height:64px !important; z-index:900 !important; background:#fff !important; border-bottom:1px solid #E2E8F0 !important; display:flex !important; align-items:center !important; justify-content:space-between !important; padding:0 1.5rem !important; box-shadow:0 1px 4px rgba(0,0,0,0.06) !important; }
    .main-content { margin:64px 0 0 260px !important; height:calc(100vh - 64px) !important; overflow:hidden !important; }
    .content-body { height:100% !important; overflow-y:auto !important; padding:1.75rem !important; background:#F1F5F9 !important; -webkit-overflow-scrolling:touch; }
    ...
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            <li class="sidebar-item <?= $script_name === 'dashboard.php' ? 'active' : '' ?>">
                <a href="dashboard.php" class="sidebar-link"><i class="fas fa-chart-line"></i> Dashboard</a>
            </li>
            <li class="sidebar-item <?= $script_name === 'mis-cursos.php' || $script_name === 'ver-clase.php' ? 'active' : '' ?>">
                <a href="mis-cursos.php" class="sidebar-link"><i class="fas fa-book-reader"></i> Mis Cursos</a>
            </li>
            <li class="sidebar-item <?= $script_name === 'explorar-cursos.php' ? 'active' : '' ?>">
                <a href="explorar-cursos.php" class="sidebar-link"><i class="fas fa-compass"></i> Explorar Cursos</a>
            </li>
            <li class="sidebar-item <?= $script_name === 'evaluaciones.php' ? 'active' : '' ?>">
                <a href="evaluaciones.php" class="sidebar-link"><i class="fas fa-file-signature"></i> Evaluaciones</a>
            </li>
            <li class="sidebar-item <?= $script_name === 'mis-notas.php' ? 'active' : '' ?>">
                <a href="mis-notas.php" class="sidebar-link"><i class="fas fa-graduation-cap"></i> Mis Notas</a>
            </li>
            <li class="sidebar-item <?= $script_name === 'historial-pagos.php' ? 'active' : '' ?>">
                <a href="historial-pagos.php" class="sidebar-link"><i class="fas fa-wallet"></i> Historial Pagos</a>
            </li>
        </ul>
    </aside>
